...
ACCOUNT_EMAIL_VERIFICATION = 'mandatory'  # Re-enabled email verification
# LOGIN_REDIRECT_URL = '/'
...
LOGOUT_REDIRECT_URL = reverse_lazy('user:login')  # Optional
...
# For development - uncomment the line below to see emails in console
# EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
